...
templates['playlistBoxTemplate'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"playlistBox\">\r\n  <h4 class=\"playListName\">Good Songs</h4>\r\n  <!-- "
    ...
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.songContent : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "    </div>\r\n</div>\r\n";
},"useData":true});
})();